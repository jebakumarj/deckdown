...
/**
 * Which stored deck is on screen — opening one on load, starting a new one and
 * deleting one. These three share `pendingChoice`, the page-load decision, so
 * they live together.
 */

import { useCallback, useEffect } from "react";
import { getAllAssets } from "@/lib/storage/assets";
import {
  deckTitle,
  deleteDeck,
  getDeck,
